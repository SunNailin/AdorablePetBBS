...
<%
 ...
 <center><span class="STYLE1">带*的为必填选项 </span></center>
   ...
   <table width="528" height="427" border="0" align="center" bgcolor="#FFFFCC">
     <form name=form1 action="modifySave.jsp"> <!--将form表单放到table中页面就不会跳转-->
	 ...
	 <tr>
        ...
        <span class="STYLE1">不可修改</span></td>
      </tr>
      <tr>
        <td height="48" bgcolor="#FFFFCC"><div align="center">密码：</div></td>
      ...
      <tr>
        <td height="49" align="center" bgcolor="#FFFFCC" ><div align="center">性别：</div></td>
		<%
			String check_male="";
			String check_female="";
	 ...
	 %>
        <td bgcolor="#FFFFCC"><input type="radio" name="sex" value="男" <%=check_male%>>
      ...
      <tr bgcolor="#FFFFCC">       
                    <td width="99" height="1" bgcolor="#FFFFCC" class="tablerow">出生日期：</td>      
      ...
      <tr>       
                          ...
                          <td width=419 height=32 bgcolor="#FFFFCC">&nbsp;&nbsp;<img id=avatar src="./PIC1/Image1.gif" alt=个人形象代表 width="32" height="32">&nbsp;-          
                            选择自己满意的头像</td>       
     </tr>       

      <tr>
        <td height="59" bgcolor="#FFFFCC"><div align="center">注册日期：</div></td>
        <td bgcolor="#FFFFCC"><input type="text" name="regdate" value="<%=regdate%>" readonly>        <span class="STYLE1">不可修改</span></td>
</td>
      </tr>
<tr bgcolor="#FFFFCC">       
