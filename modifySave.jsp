...
{
   sql="update users set username='"+name+"',password='"+password+"',sex='"+sex+"',email='"+email+"',qq='"+qq+"',head='"+head+"',userstatus='正常' where userid="+id;            
}
 else
 {
     sql="update users set username='"+name+"',password='"+password+"',sex='"+sex+"',email='"+email+"',qq='"+qq+"',head='"+head+"',birthday=#"+birthday+"#,userstatus='正常' where userid="+id;            
}
