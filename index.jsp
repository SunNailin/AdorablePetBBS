...
<center>
			...
			<table width="1000">
  <tr  bgcolor="#FFFF99">
    <td width="145" height="30"><p>版块列表</p>    </td>
	<td width="400" >板块简介</td>
    <td width="100" >主题数量</td>
  </tr>
  <%
  ...
  String classid=rs.getString("classid");//版块号
  ...
  %><tr>
	  ...
	  <td width="400" bgcolor="#ffffcc"><%=classintro%>
		  ...
		  <td width="100" bgcolor="#ffffcc"><span class="STYLE2"><%=tnum%></span></td>  <!显示主题数量-->
